...
(* OASIS_START *)
(* DO NOT EDIT (digest: cf8a2074bd15af85ba06c95ac97865b9) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Andy Ray"];
          homepage = Some "https://github.com/ujamjar/hardcaml-wave-term";
          synopsis = "A terminal based digital waveform viewer";
          description =
            Some [OASISText.Para "A terminal based digital waveform viewer"];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Wave"; "Gfx"; "Render"; "Write"; "Sim"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "hardcaml-waveterm";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "HardCamlWaveLTerm";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "HardCamlWaveTerm";
                   ...
                   {
                      lib_modules = ["Gfx_lterm"; "Widget"; "Ui"; "Api"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "HardCamlWaveTerm";
                      lib_findlib_name = Some "lterm";
                      lib_findlib_containers = []
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build test apps";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "testsim.ml"});
               Executable
                 ({
                     cs_name = "testsim_lwt";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "testsim_lwt.ml"});
               Executable
                 ({
                     cs_name = "wavedraw";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_path = "apps";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "HardCamlWaveTerm"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "wavedraw.ml"});
               Executable
                 ({
                     cs_name = "waveterm";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "HardCamlWaveLTerm"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "waveterm.ml"});
               Executable
                 ({
                     cs_name = "testwidget";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "testwidget.ml"});
               Executable
                 ({
                     cs_name = "testwidget_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "testwidget_lwt.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/ujamjar/hardcaml-wave-term.git";
                      src_repo_browser =
                        Some "https://github.com/ujamjar/hardcaml-wave-term";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\199\233\1841\193K\199^\240\194\211\030l3\223n";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
